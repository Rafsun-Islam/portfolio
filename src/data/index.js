...
export const skillCategories = [
  {
    ...
    label: "⚡ Frontend",
    skills: [
      { icon: "⚛", name: "React / Next.js", level: "Beginner", width: 0.88 },
      { icon: "📘", name: "TypeScript", level: "Beginner", width: 0.76 },
      { icon: "🎨", name: "CSS / Tailwind", level: "Beginner", width: 0.93 },
      { icon: "✨", name: "Animations", level: "Beginner", width: 0.72 },
    ],
  },
  {
    id: "backend",
    label: "🔧 Backend",
    skills: [
      { icon: "🟢", name: "Node.js / Express", level: "Beginner", width: 0.86 },
      { icon: "🐍", name: "Python / FastAPI", level: "Beginner", width: 0.89 },
      { icon: "🗄", name: "PostgreSQL", level: "Beginner", width: 0.74 },
      { icon: "⚡", name: "Redis / MongoDB", level: "Beginner", width: 0.66 },
    ],
  },
  {
    id: "devops",
    label: "☁ DevOps",
    skills: [
      { icon: "🐳", name: "Docker", level: "Beginner", width: 0.74 },
      { icon: "☁", name: "AWS (EC2, S3, RDS)", level: "Beginner", width: 0.6 },
      { icon: "🔄", name: "CI/CD Pipelines", level: "Beginner", width: 0.72 },
      { icon: "🐧", name: "Linux / Bash", level: "Beginner", width: 0.78 },
    ],
  },
  {
    id: "cs",
    ...
    skills: [
      ...
      { icon: "🏗", name: "System Design", level: "Beginner", width: 0.7 },
      {
        icon: "🔒",
      ...
      { icon: "🔀", name: "Agile / Scrum", level: "Beginner", width: 0.76 },
    ],
  },
];
